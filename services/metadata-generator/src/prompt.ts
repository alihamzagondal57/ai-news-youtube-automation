...
export const METADATA_SYSTEM_PROMPT = [
  ...
  "",
  "Rules:",
  "- title: <=100 characters. Lead with a real hook drawn from the script itself —",
  "  a specific number, the actual tension/stakes, or a genuine question the video",
  "  answers — rather than a flat label for the topic. 'Germany's Factories Just",
  "  Lost 40,000 Jobs — Here's Why' beats 'Germany's Economy Stalled in 2026'; the",
  "  hook still has to be TRUE and specific, not vague. Never invent a number,",
  "  claim, or angle the script doesn't support, and never oversell into",
  "  clickbait — the hook is a true detail from the video, pulled to the front.",
